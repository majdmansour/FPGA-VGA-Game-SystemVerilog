...
const int	x_FRAME_LEFT	=	(-1024)* FIXED_POINT_MULTIPLIER; 
...
begin : fsm_sync_proc
	...
	if (resetN == 1'b0) begin 
		...
		//------------
				outOfScreenFlag <= 1'b0;
				
				if(stopByCollision == 1)
					Xspeed <= 0;

				if(keyIsPressed[6] && bgMove == 1 && stopByCollision == 0) 
					Xspeed <= X_SPEED;
